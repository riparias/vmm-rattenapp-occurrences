...
# drop table occurrences if exists
DBI::dbExecute(con, "DROP TABLE IF EXISTS occurrences")
# import occurrences
DBI::dbWriteTable(con, "occurrences", occurrences)
# drop table life_mica_obs if exists
DBI::dbExecute(con, "DROP TABLE IF EXISTS life_mica_obs")
