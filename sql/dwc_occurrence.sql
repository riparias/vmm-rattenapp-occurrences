...
-- TAXON
  CASE
    ...
    WHEN o."Sporen Waarnemingen Naam" = 'Gevlekte amerikaanse rvk' THEN 'Faxonius limosus'
    WHEN o."Sporen Waarnemingen Naam" = 'Gevlekte amerikaanse rivi' THEN 'Faxonius limosus'
    WHEN o."Sporen Waarnemingen Naam" = 'Rode amerikaanse rvk' THEN 'Procambarus clarkii'
